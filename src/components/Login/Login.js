			...
			<div className='authentication-container'>
				...
				<div className={this.state.create ? 'createAccount-container' : 'hide'}>
					<form className='createForm-content'>
						...
						<input
							...
							className='authentication-inputField'
						/>
						<button className='authentication-btn' onClick={this.createAccount}>
							Create Account
						</button>
					</form>
				</div>
				...
				<div className={this.state.create ? 'hide' : 'login-container'}>
					<form className='loginForm-content'>
						...
						<input
							...
							className='authentication-inputField'
						/>
						<button className='authentication-btn' onClick={this.checkLogin}>
							Login
						</button>
					</form>
				</div>
				...
				<div className='below-auth-container'>
					<div className='guestSignin-text'>
						<h3>
							Sign in as Guest.{' '}
							<span className='toggle-auth-link' onClick={this.guestSignIn}>
								Click here.
							</span>
						</h3>
					</div>
					<div>
						<h3 className={this.state.create ? '' : 'hide'}>
							Have an account?{' '}
							<span className='toggle-auth-link' onClick={() => this.toggleLogin()}>
								Click here to login.
							</span>
						</h3>
						<h3 className={this.state.create ? 'hide' : ''}>
