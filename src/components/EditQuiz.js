...
// const baseUrl = 'https://lambda-study-app.herokuapp.com/'; // deprecated
	...
	render() {
		return (
			<div className='editingQuiz-container'>
				<div className='editForm-title-text'>Edit Quiz Information</div>
				...
				<div className='editQuizForm-btn-container'>
					<button className='editQuizForm-btn' onClick={this.saveQuizEdits}>
						Save Edit
					</button>
					<button className='editQuizForm-btn' onClick={this.cancelEdit}>
						Cancel Edit
					</button>
				</div>
			</div>
...
export default connect(null, { editQuizInfo })(EditQuiz);
